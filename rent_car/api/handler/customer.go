...
func (h Handler) CreateCustomer(c *gin.Context) {
	...
	if err := check.ValidateEmailAddress(customer.Email); err != nil {
...
func (h Handler) ChangePasswordCustomer(c *gin.Context) {
	...
	if err := check.IsValidPassword(pass.NewPassword); err != nil {
...
// @Accept 			json
// @Produce 		json
// @Param 			search query string false "customers"
